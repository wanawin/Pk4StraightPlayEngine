# straight_play_decision_engine_v1.py
# Reusable AABC straight-play companion app
# Build marker: STRAIGHT_DECISION_ENGINE_V1__2026-06-13
...
BUILD_ID = "STRAIGHT_DECISION_ENGINE_V1__2026-06-13"
...
def read_table_upload(uploaded_file) -> pd.DataFrame:
    ...
    # TXT: try auto delimiter, then fallback to line parser.
