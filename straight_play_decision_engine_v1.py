    ...
    try:
        ...
        if not run_straight:
            ...
            if not out.empty:
                ...
                st.text(printable_txt)

                csv = out.to_csv(index=False).encode("utf-8")
                txt = printable_txt.encode("utf-8")
                c1, c2 = st.columns(2)
                c1.download_button("Download straight recommendations CSV", csv, file_name="straight_play_recommendations.csv", mime="text/csv")
                c2.download_button("Download printable straight TXT", txt, file_name="straight_play_recommendations_PRINTABLE.txt", mime="text/plain")
